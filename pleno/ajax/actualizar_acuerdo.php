...
try {
    ...
    if (!$auth['authorized'] || !in_array((int)($auth['tipoUsuarioId'] ?? 0), [6, 20], true)) {
        ...
        echo json_encode(['success' => false, 'mensaje' => 'No tiene permisos para editar acuerdos.'], JSON_UNESCAPED_UNICODE);
        exit();
    }
    ...
    $resultado = $modelo->actualizar($idAcuerdo, $textoAcuerdo, $idUsuario);
    ...
    echo json_encode(['success' => false, 'mensaje' => 'No fue posible editar el acuerdo.'], JSON_UNESCAPED_UNICODE);
}
